...
export const RosterView: React.FC = () => {
  ...
  const handleMonthChange = useCallback(async (year: number, month: number) => {
    ...
    try {
      const dates = await rosterApi.getRosterDatesInRange(from, to);
      setRosterDates(dates);
    } catch {
      // silently fail — non-critical for calendar display
    }
  }, []);
        ...
        <div className="flex-1 min-w-0">
          ...
          {loading ? (
            ...
            <CrewGrid
              ...
              onSlotSwap={isReadOnly ? undefined : handleSlotSwap}
