...
const isAdmin = (role?: string) => role === 'admin' || role === 'ops_director';
    ...
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
      <div className="max-w-screen-2xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <NavLink to={isAdminUser ? '/roster' : '/my-schedule'} className="flex items-center gap-2.5 font-bold text-blue-700 text-lg hover:text-blue-800 transition-colors">
          ...
          <div className="hidden lg:flex items-center gap-1">
            {navItems.map((item) => (
              ...
              >
                ...
                {item.to === '/exceptions' && isAdminUser && totalFlags > 0 && (
                  <span className={`
